// https://github.com/rlabrecque/Steamworks.NET-GameServerTest/blob/master/Assets/Scripts/GameServerTest.cs credit
...
public class SteamServerEngine : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		// NOTE: original example had 6 variables removed one at random. Seems to have work?? <<<<<<<
		...
		m_bInitialized = GameServer.Init(0, SPACEWAR_SERVER_PORT, SPACEWAR_MASTER_SERVER_UPDATER_PORT, eMode, SPACEWAR_SERVER_VERSION);
		if (!m_bInitialized)
		{
